  ...
  appendFrame: function(settings, videoDetails){
    var addVideo = function(){
      ...
      if (videoDetails.provider != 'html5' && settings.container.find('.mediaWrapper').length < 1){
        ...
        settings.container.find('.hsContainer__image')
        .css({
...
var product = {
  init: function(){
    ...
    if (slideshowAnimation == 'zoom' && $(window).width() > 798 ){
    ...
    if ($cartBtn && $cartBtn.length) {
      ...
      if (cart.item_count == 0) {
        ...
        cart_items_html += '<li class="mm-label">' +
            '<p class="mm-counter price"><span class="money">' + Shopify.formatMoney(cart.total_price, $('body').data('money-format')) + '</span></p>' +
            '<a href="/cart">' +
          ...
          '<li class="mm-subtitle clearfix">';
            ...
            cart_items_html += '<textarea id="cart-note" name="note" rows="2" placeholder="" class="clearfix">'+cart_note+'</textarea>';
            ...
            "I Agree to the \u003cb\u003e\u003ca href=\"#terms\" class=\"lightbox terms\"\u003eTerms \u0026 Conditions\u003c\/a\u003e\u003c\/b\u003e" +
            '</label></aside>';
...
selectCallback = function(variant, selector) {
  ...
  if (variant && variant.available == true) {
    ...
    if (variant.price > 0) {
      ...
      $('.current_price', $product).html("Currently Unavailable");
    }
